...
|    sendRenewStream    |                  false                   |          0 *false*          | If sendRenewStream is 1, the server will send RenewStream via SET\_PARAMETER when a new client connects. Only valid for RTSP URIs |
